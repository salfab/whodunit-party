...
WITH name_fixes(title, role, secret_marker, character_name) AS (
  VALUES
    ...
    ('Murder at the Manor', 'innocent', 'embezzling funds', 'Mr. Edmund Butler'),
    ...
    ('Death at the Opera House', 'innocent', 'original composition', 'Maestro Vincent Moreau'),
    ...
    ('The Vanishing Heir', 'innocent', 'forging documents', 'Victor Beaumont'),
    ...
    ('Murder on the Orient Express', 'innocent', 'destroyed your family', 'Silas Ward'),
    ...
    ('Death at the Museum', 'innocent', 'forgeries and falsified artifacts', 'Professor Lionel Graves'),
    ...
    ('The Poisoned Playwright', 'innocent', 'stole your entire play', 'Edwin March'),
    ...
    ('Murder at the Masquerade', 'innocent', 'blackmailing you', 'Count Luciano Verdi'),
