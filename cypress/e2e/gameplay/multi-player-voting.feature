Feature: Multi-Player Voting and Game Start
  ...
  # Note: These tests require local Supabase database running
  # Run with: npx supabase start (in project root)
  # Then: npx cypress run --spec "cypress/e2e/gameplay/multi-player-voting.feature"
  
  @integration @multi-player
