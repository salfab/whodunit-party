...
Then('I should not see the guilty confession text', () => {
  // The dark secret is only shown on the guilty player's screen (they read it
  // aloud) — the investigator must not see it on the results card.
